...
import com.genius.assemble.fragments.BaseFragment;
import com.genius.assemble.fragments.MainLayoutFragment;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(MainLayoutFragment
            .newInstance("Start Unity \n Assemble", getString(R.string.footnote_sample),
